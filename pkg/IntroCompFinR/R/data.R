...
#' Daily adjusted closing price for Microsoft stock
#'
#' A \samp{xts} object of daily adjusted closing price for Microsoft from 1993-01-04 to 2019-12-31.
#'
#' @format A \samp{xts} object on 1993-01-04 to 2019-12-31 containing:
#' \describe{
#'   \item{MFST}{adjusted closing price in USD}
#' }
#' Indexed by objects of class: [Date] TZ: UTC.
...
#' A \samp{xts} object of daily adjusted closing price for Amazon from Jan-1998 to Jan-2015.
#'
#' @format A \samp{xts} object on Jan-1998 to Jan-2020 containing:
#' \describe{
#'   \item{AMZN}{adjusted closing price in USD}
#' }
#' Indexed by objects of class: [Date] TZ: UTC.
...
#' A \samp{xts} object of daily adjusted closing price for Boeing from Jan-1993 to Jan-2015.
#'
#' @format A \samp{xts} object on Jan-1993 to Jan-2019 containing:
#' \describe{
#'   \item{BA}{adjusted closing price in USD}
#' }
#' Indexed by objects of class: [Date] TZ: UTC.
...
#' Daily adjusted closing price for Nordstrom stock
#'
#' A \samp{xts} object of daily adjusted closing price for Nordstrom from Jan-1993 to Jan-2020.
#'
#' @format A \samp{xts} object on Jan-1993 to Jan-2015 containing:
#' \describe{
#'   \item{JWN}{adjusted closing price in USD}
...
#' A \samp{xts} object of daily adjusted closing price for Costco from Jan-1993 to Jan-2015.
#'
#' @format A \samp{xts} object on Jan-1993 to Jan-2020 containing:
#' \describe{
#'   \item{COST}{adjusted closing price in USD}
#' }
#' Indexed by objects of class: [Date] TZ: UTC.
